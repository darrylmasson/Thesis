...
This process of scaling and clustering can be repeated in an iterative fashion, but the problem very quickly reaches a stalemate unless different variables are clustered.