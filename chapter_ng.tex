...
\begin{figure}[!htb]
\centering
%\includegraphics[width = \columnwidth]{figs/exprimental_setup_ptb_red.pdf}
\includegraphics[width = \columnwidth, clip=true, trim =0 0 0 0]{setup_image_straightened_red.png}
...
\begin{figure}[!htb]
\centering
\includegraphics[width = 0.9\columnwidth, clip=True, trim= 0  0 0 0]{coordinate_schematic_v2_0.png} % left lower right upper
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=1.0\textwidth]{hist2d_bg_and_fg.pdf}
...
We select neutron-induced events by cutting at the $99\1{\%}$ electronic recoil background rejection line in the pulse shape discrimination parameter space, as indicated in Fig.~\ref{hist2d}. We subtract the background rate in the selected region by computing the number of events that pass the cut in the background data set and using the appropriate scaling for live-time.
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=1\columnwidth]{acceptance.pdf}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=\linewidth]{mc_spectrum.pdf}
...
\begin{figure}[!htbp]
\begin{center}
\includegraphics[width=\linewidth]{fit_with_acc_r.pdf}
...
\begin{figure}[!htbp]
\includegraphics[width=\columnwidth]{fig_fluxandfit_v2_0.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width = \columnwidth]{fig_angle_scan.pdf}
